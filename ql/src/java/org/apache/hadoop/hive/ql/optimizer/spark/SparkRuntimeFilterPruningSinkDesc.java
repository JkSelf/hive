...
@Explain(displayName = "Spark Runtime Filter Partition Pruning Sink Operator")
public class SparkRuntimeFilterPruningSinkDesc extends AbstractOperatorDesc {
  ...
  private ArrayList<ExprNodeDesc> rsValueCols = new ArrayList<ExprNodeDesc>();

  private Path path;

  private String targetWork;

  private BaseWork targetMapWork;
  ...
  public ArrayList<ExprNodeDesc> getRsValueCols() {
    return rsValueCols;
  }

  public void setRsValueCols(ArrayList<ExprNodeDesc> rsValueCols) {
    this.rsValueCols = rsValueCols;
  }

  public BaseWork getTargetMapWork() {
    return targetMapWork;
  }

  public void setTargetMapWork(BaseWork mapWork) {
    this.targetMapWork = mapWork;
  }
}
